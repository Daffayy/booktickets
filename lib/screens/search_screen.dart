    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          Gap(AppLayout.getHeight(40)),
          const AppDoubleTextWidget(bigText: "Upcoming flight", smallText: "v"
              "iew all"),
              ...
              Container(
                ...
                child: Column(
                  children: [
                    ...
                    Text("20% discount on the early booking this flight. "
                        "Don't miss out chance", style: Styles.headLineStyle2,)
                  ],
                ),
              ),
              Column(
